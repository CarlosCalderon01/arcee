...
CREATE INDEX "idx_businesses_city_id" ON "businesses" USING BTREE ("city_id");

CREATE INDEX "idx_businesses_country_id" ON "businesses" USING BTREE ("country_id");

CREATE INDEX "idx_businesses_state_id" ON "businesses" USING BTREE ("state_id");

CREATE UNIQUE INDEX "unique_city_name_per_state" ON "cities" ("state_id", "name");

CREATE INDEX "idx_cities_state_id" ON "cities" USING BTREE ("state_id");

CREATE INDEX "idx_genders_by_languages_genders_id" ON "genders_by_languages" USING BTREE ("genders_id");

CREATE INDEX "idx_genders_by_languages_language_id" ON "genders_by_languages" USING BTREE ("language_id");

CREATE UNIQUE INDEX "unique_holiday_per_country_language" ON "holidays_by_countries" ("country_id", "language_id", "holiday_date");

CREATE INDEX "idx_holidays_by_countries_country_id" ON "holidays_by_countries" USING BTREE ("country_id");

CREATE INDEX "idx_holidays_by_countries_language_id" ON "holidays_by_countries" USING BTREE ("language_id");
...
CREATE INDEX "idx_type_documents_country_id" ON "type_documents" USING BTREE ("country_id");

CREATE INDEX "idx_type_documents_language_id" ON "type_documents" USING BTREE ("language_id");

CREATE INDEX "idx_users_city_id" ON "users" USING BTREE ("city_id");

CREATE INDEX "idx_users_country_id" ON "users" USING BTREE ("country_id");

CREATE INDEX "idx_users_state_id" ON "users" USING BTREE ("state_id");
